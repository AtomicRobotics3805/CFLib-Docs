...
### isDone
- Default value: `false`
- Type: property for [`_isDone`](#_isdone)
- Declaration: `private`
### _isDone
- Default value: `false`
- Type: `Boolean`
...
*Definition in [`com.atomicrobotics.cflib/Command.kt`](https://github.com/AtomicRobotics3805/CFLib/blob/main/cflib/src/main/kotlin/com/atomicrobotics/cflib/Command.kt#L12)*