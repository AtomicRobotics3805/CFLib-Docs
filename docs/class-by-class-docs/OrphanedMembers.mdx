...
This function returns a [sequential comand group](CommandGroup/SequentialCommandGroup). It should be used as follows:
```kotlin
...
This function returns a [parallel command group](CommandGroup/ParallelCommandGroup). It should be used as follows:
```kotlin
